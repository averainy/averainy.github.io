    ...
    , function(t, e, r) {
        ...
        var w, _ = function() {
            function t(e, r, n) {
                ...
                this.TypeID = e,
                this.Alphabet = r,
                this.CharCount = i || this.Alphabet.length,
                this.m_chFirst = n ? this.Alphabet.charCodeAt(0) : null,
                this.m_chLast = n ? this.Alphabet.charCodeAt(this.CharCount - 1) : null,
                this.CharSize = Math.log2(this.CharCount),
                i || b(this.m_chLast - this.m_chFirst == this.CharCount - 1 || !n)
            }
            return p(t, [{
                key: "Contains",
                value: function(t) {
                    if (null !== this.m_chLast)
                        return t >= this.m_chFirst && t <= this.m_chLast;
                    if (0 === this.Alphabet.length)
                        throw new Error("Don't call for catch-none set");
            ...
            function t(e, r, n, i) {
                ...
                null === e || 0 === e.length)
                    throw new Error;
                this.m_strAlph = e,
                this.m_uBaseWeight = r,
                this.m_uCharWeight = n,
                this.m_uOccExclThreshold = i,
                this.m_dHisto = {}
            }
            return p(t, [{
                key: "Reset",
                ...
                value: function() {
                    for (var t = this.m_uBaseWeight * this.m_strAlph.length, e = 0, r = Object.values(this.m_dHisto); e < r.length; e++) {
                        var n = r[e];
                        b(n >= 1),
                        n > this.m_uOccExclThreshold && (t += (n - this.m_uOccExclThreshold) * this.m_uCharWeight)
                    }
                    for (var i = 0, o = t, a = 0, u = Object.values(this.m_dHisto); a < u.length; a++) {
                        var h = u[a]
                          , s = this.m_uBaseWeight;
                        h > this.m_uOccExclThreshold && (s += (h - this.m_uOccExclThreshold) * this.m_uCharWeight),
                        i -= h * Math.log2(s / o)
                    }
                    return i
                }
            ...
            var o;
            f(this, t),
            "number" == typeof i ? (this.Position = e,
            this.Length = r,
            this.PatternID = n,
            this.Cost = i,
            this.SingleCharType = null) : (o = n,
            this.Position = e,
            this.Length = r,
            this.PatternID = o.TypeID,
            this.Cost = o.CharSize,
            this.SingleCharType = o)
        }, E = function t(e, r) {
            f(this, t),
            this.Position = e,
            this.Path = r
        ...
        function T(t, e, r) {
            if (!(e.length <= 2)) {
                for (var n = String.fromCharCode.apply(null, e), i = 0, o = 0; o < n.length && 48 == n.charCodeAt(o); ++o)
                    ++i;
                var a = Math.log2(i + 1);
                if (i < n.length) {
                    var u = n.substring(i);
                    ...
                    for (var h = 0; h <= r - u; ++h) {
                        ...
                        if (s && -1 === s.indexOf("\0"))
                            if (H(e, t, h, s, 0))
                                ...
                                H(e, t, h, i.substring(h, u), 1.5) && (n = W(n, h, u))
                    }
        }
        function W(t, e, r) {
            for (var n = "", i = 0; i < r; i++)
        ...
        function k(t) {
            if (t.charCodeAt(0) >= 192 && t.charCodeAt(0) <= 198)
                return "a";
            if (t.charCodeAt(0) >= 200 && t.charCodeAt(0) <= 203)
                return "e";
            if (t.charCodeAt(0) >= 204 && t.charCodeAt(0) <= 207)
                return "i";
            if (t.charCodeAt(0) >= 210 && t.charCodeAt(0) <= 214)
                return "o";
            if (t.charCodeAt(0) >= 217 && t.charCodeAt(0) <= 220)
                return "u";
            if (t.charCodeAt(0) >= 224 && t.charCodeAt(0) <= 230)
                return "a";
            if (t.charCodeAt(0) >= 232 && t.charCodeAt(0) <= 235)
                return "e";
            if (t.charCodeAt(0) >= 236 && t.charCodeAt(0) <= 239)
                return "i";
            if (t.charCodeAt(0) >= 242 && t.charCodeAt(0) <= 246)
                return "o";
            if (t.charCodeAt(0) >= 249 && t.charCodeAt(0) <= 252)
                return "u";
            switch (t) {
            case "4":
            case "@":
        ...
        function H(t, e, r, n, i) {
            ...
            for (var s = n.length, c = function(t, e, r, n, i) {
                for (var o = 0, a = 0; a < i; ++a)
                    t.charCodeAt(e + a) !== r.charCodeAt(n + a) && ++o;
                return o
            }(n, 0, e, r, s), l = Math.log2(a), f = Math.min(c, s - c), d = s; d > s - f; --d)
                l += Math.log2(d);
            for (var p = f; p >= 2; --p)
                l -= Math.log2(p);
            return l += i * c,
            t[r].push(new P(r,s,g.Dictionary,l)),
            !0
        }
        function I(t) {
            ...
            !function() {
                if (null == w) {
                    var t = v
                      , e = (t += " ").length
                      , r = A.length;
                    (w = []).push(new _(g.LowerAlpha,y,!0)),
                    w.push(new _(g.UpperAlpha,C,!0)),
                    w.push(new _(g.Digit,m,!0)),
                    w.push(new _(g.Special,t,!1)),
                    w.push(new _(g.High,A,!1)),
                    w.push(new _(g.Other,65474 - e - r))
                }
            }();
            for (var e = t.length, r = [], n = 0; n < e; n++)
                r[n] = [new P(n,1,x(t.charCodeAt(n)))];
            !function(t, e) {
                for (var r = function(t) {
                    for (var e = [], r = 0; r < t.length; r++)
                        e.push(t.charCodeAt(r));
                    return e
                }(t), n = t.length, i = 65535, o = n / 2; o >= 3; --o)
                    for (var a = 0; a <= n - 2 * o; ++a) {
                        for (var u = !1, h = a + o; h <= n - o; ++h)
                            if (D(r, a, h, o)) {
                                var s = Math.log2(a + 1) + Math.log2(o);
                                e[h].push(new P(h,o,g.Repetition,s)),
                                i = M(r, h, o, i),
                                u = !0
                            }
                        u && (i = M(r, a, o, i))
            ...
            function(t, e) {
                for (var r = t.length, n = [], i = 0; i < r; ++i) {
                    ...
                    o >= 48 && o <= 57 ? n.push(o) : (T(e, n, i - n.length),
                    n = [])
                }
                T(e, n, r - n.length)
            }(t, r),
            ...
            for (c.push(new E(0,[])); c.length > 0; ) {
                ...
                if (f.Position >= e) {
                    ...
                    for (var p = r[f.Position], W = p.length - 1; W >= 0; --W) {
                        var k = p[W];
                        b(k.Position == f.Position),
                        b(k.Length >= 1);
                        var H = [];
                        H.push.apply(H, l(f.Path)),
                        H.push(k);
